            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-uppercase mt-1 mb-0 float-left">Create new Site</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('sites.store') }}" method="POST" id="form-create">
                            @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="{{ data_get($field, 'type', 'text') }}" class="form-control" id="{{ data_get($field, 'id') }}"
                                                   ...
                                                   name="{{ data_get($field, 'name') }}" value="{{ old(data_get($field, 'value_key')) }}"
