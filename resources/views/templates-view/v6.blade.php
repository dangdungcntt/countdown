...
<head>
	...
	@include('templates-view.partial.custom-style', ['v' => 'v6'])
	
</head>
<body>
	
	<div class="main-area-wrapper" style="background-image:url('{{ data_get($data, 'background_url', asset('templates-view/images/countdown-6-1600x900.jpg')) }}');">
