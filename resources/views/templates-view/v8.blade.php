...
<head>
	...
	@include('templates-view.partial.custom-style', ['v' => 'v8'])
	
</head>
<body>
	
	<div class="main-area-wrapper">
		<div class="main-area center-text" style="background-image:url('{{ data_get($data, 'background_url', asset('templates-view/images/countdown-7-1600x900.jpg')) }}');" >
